...
# -----------------------------
# 14. Further Data Cleaning for Handling Time Model in step 5
# Re-run Steps 4-11 for Handling Time Data
# -----------------------------
...
#     crime_sf_final$InitialPriority[i] = "1J"
#   }
#   if (crime_sf_final$InitialPriority[i] %in% twos){
#     crime_sf_final$InitialPriority[i] = "2A"
#   }
